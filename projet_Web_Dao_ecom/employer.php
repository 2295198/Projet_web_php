			...
			<table class="table table-striped table-hover">
				...
				<?php 
					...
					<tr>
						...
						<td><?= $article->getId() ?></td>
						<td><img src="<?= $article->getImage() ?>" alt="" width=70px height=50px></td>
						<td style ="font-size:12px"><?= $article->getCategorie() ?></td>
						<td style ="font-size:12px"><?= $article->getNomArticle() ?></td>
						<td style ="font-size:12px"><?= $article->getDescription() ?></td>
						<td style ="font-size:12px"><?= $article->getPrix() ?></td>
						<td style ="font-size:12px"><?= $article->getQuantite() ?></td>
						<td style ="font-size:12px"><?= $article->getDateCreation() ?></td>
		...
		<div class="modal-content">
			<form>
                ...
                <div class="form-group">
					...
					<div class="form-group">
						<label>imageArt</label>
						<input type="text" class="form-control" id="imageArt" name="imageArt" required>
					</div>
					<div class="form-group">
