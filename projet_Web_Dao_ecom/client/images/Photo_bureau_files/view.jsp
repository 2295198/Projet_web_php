...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-9-22-dsktp-french.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
			...
			css: ".usi_display * {\tfont-size: 1em;\tline-height: 1.2;\tbox-sizing: border-box;\tcolor: inherit;\tfont-family: inherit;}.usi_display {\tcolor: #000;\tfont-family: inherit;}#usi_content {\tbackground: none;}.usi_head {\ttext-align: center;\tfont-size: 1.2em;  font-weight: bold;\tpadding: 2%;\twidth: 35%;\tposition: absolute;\ttop: 2%;\tleft: 1%;}#usi_close {\twidth: 4em;\theight: 4em;\ttext-align: center;\tfont-size: 1.5em;\tleft: auto;\tright: 0;\tbackground: none;\tcursor: pointer;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {  background: none;\tborder: none;\toutline: none;\tbox-shadow: none;}.usi_submitbutton {  background: none;\tposition: absolute;\ttop: 38.5%;\tleft: 34%;\twidth: 32%;\theight: 10%;\tmargin: 0;\tpadding: 0;\tdisplay: inline-block;\toutline: none;\tborder: none;\tcursor: pointer;\ttext-align: center;\tbox-shadow: none;}/* Disclaimer */.usi_disclaimer {\tposition: absolute;\ttop: 94%;\tleft: 10%;\twidth: 80%;\ttext-align: center;\tcolor: #eee;\tfont-size: 1em;  font-weight: bold;  text-shadow: 1px 1px #000;}.usi_disclaimer a {\ttext-align: center;\tcolor: #eee;\tfont-size: 1em;  font-weight: bold;\ttext-decoration: underline !important;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
...
usi_js.click_cta = function(){
	try {
		usi_js.set_coupon();
    var destination_url = "https://www.shutterstock.com/pricing";
...
usi_js.display_vars.p1_html = [
	'<div class="usi_sr_only">shutterstock flex. Profitez d\u2019images, de vid\u00E9os et de musique. Avec 1 seul et m\u00EAme abonnement.</div>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Lancez-vous"></button>',
].join('');
		...
		preload_img:function(src) {
			try {
				...
				if (typeof(src) != "undefined" && src != null && src.indexOf("//") != -1) {
					...
					img_preloader.innerHTML = '<div style="position:absolute;left:-2000px;top:-2000px;"><img aria-hidden="true" src="'+src+'" onerror="usi_js.error_report_image(event, this);"/></div>';
		...
		set_backtrap_delay:function() {
			try {
				...
				if (typeof(document.readyState) != "undefined" && document.readyState !== "complete") {
					if (usi_js.machine.is_chrome_iphone) return;
